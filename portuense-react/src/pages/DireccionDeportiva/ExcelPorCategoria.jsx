...
export default function ExcelPorCategoria() {
  ...
  const fetchExcel = async () => {
    ...
    try {
      const res = await fetch(
        `http://localhost:8000/api/excels-categoria/?categoria=${categoria}&equipo=${equipo}`,
        {
  ...
  const handleUpload = async (e) => {
    ...
    const url = excel
      ? `http://localhost:8000/api/excels-categoria/${excel.id}/`
      : "http://localhost:8000/api/excels-categoria/";
